/*
  metricsPage.js
  Renderer script for the Metrics Page.
  Displays dragon details and handles navigation back to dragon page.
*/
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  // Get dragon image from main process
  ...
  // Get random int to determine which dragon to show
  ...
  // Exit button returns to dragon page
